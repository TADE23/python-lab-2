...
def main(args):
    ...
    # yields for some common periods of time (e.g. 1 month, 1 year, 5 years, 10 years)
    print("1 year: ", deposit(initial_sum, percent, fixed_period, 12))
    print("5 years: ", deposit(initial_sum, percent, fixed_period, 60))
    print("10 years: ", deposit(initial_sum, percent, fixed_period, 120))

    # one year percent yield
    print("one year percent yield: ", ((deposit(initial_sum, percent, fixed_period, 12)/(initial_sum/100)-100)))
